 ...
 */
@Entity
@Table(name = "MapMenu", uniqueConstraints = @UniqueConstraint(columnNames= {"functionName", "roleName"}))
public class MapMenuObject implements Serializable {
